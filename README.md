...
A companion mobile app for [techenby/sunny](https://github.com/techenby/sunny) built with NativePHP.
...
4. `composer run setup`
5. Link the directory to Valet or Herd
